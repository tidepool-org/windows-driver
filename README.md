...
- When you publish the new drivers on the website, remember to also [whitelist[(https://submit.symantec.com/whitelist/isv/) the Windows USB driver with Symantec.
